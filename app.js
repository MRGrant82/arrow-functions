...
//   };
// };
const objectLit = () => ({key1: 'value1', key2: 'value2', key3: 'value3'});
...
// const Student = (name, age, hometown) => {this.name = name; this.age = age; this.hometown = hometown;};

// // let joe = new Student('Joe', 'Schmoe', 100);
// let student = new Student('Joe', 'Schmoe', 100);
// // TODO: Uncomment the following line of code to see the output in the browser console
...
function Student(name, age, hometown) {
  ...
  let student = new Student('Joe', 'Schmoe', 100);
  console.log(student); // Output: Student { name: 'Joe', age: 'Schmoe', hometown: 100 }
...
Student.prototype.greeting = function() {
  ...
  let joe = new Student('Joe', 'Schmoe', 100);
  console.log(joe.greeting()); // Output: "Hi, my name is Joe"
...
// STEP 11
// How do arrow functions affect constructor functions?  Arrow functions don't have their own "this method.  They cause wonkiness"
...
// joe.scope(): this refers to joe instance.

// 2. What is "this" when joe.scopeArrow() is invoked?
// joe.scopeArrow(): this refers to global scope.
